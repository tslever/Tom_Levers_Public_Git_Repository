...
def join_datasets(
    ...
    if path_to_dataset_1.endswith('.xlsx') and path_to_dataset_2.endswith('.xlsx'):
        ...
        column_of_concatenated_elements_of_columns_corresponding_to_join_keys_of_data_frame_2 = data_frame_2[list_of_join_keys[0]]
        for i in range(1, len(list_of_join_keys)):
            column_of_concatenated_elements_of_columns_corresponding_to_join_keys_of_data_frame_2 = column_of_concatenated_elements_of_columns_corresponding_to_join_keys_of_data_frame_2 + '|' + data_frame_2[list_of_join_keys[i]]
        ...
        data_frame_merged_on_list_of_join_keys = data_frame_1.merge(right = data_frame_2, how = type_of_join, left_on = list_of_join_keys, right_on = list_of_join_keys, sort = False, suffixes = ('_1', '_2'))
        data_frame_merged_on_list_of_join_keys.sort_values(by = list_of_join_keys, inplace = True)
        ...
        #        break
        column_of_concatenated_elements_of_columns_corresponding_to_list_of_join_keys_of_data_frame_merged_on_list_of_join_keys = data_frame_merged_on_list_of_join_keys[list_of_join_keys[0]]
        for i in range(1, len(list_of_join_keys)):
            column_of_concatenated_elements_of_columns_corresponding_to_list_of_join_keys_of_data_frame_merged_on_list_of_join_keys = column_of_concatenated_elements_of_columns_corresponding_to_list_of_join_keys_of_data_frame_merged_on_list_of_join_keys + '|' + data_frame_merged_on_list_of_join_keys[list_of_join_keys[i]]
        ...
        list_of_join_keys_with_spaces_replaced_with_underscores = [join_key.replace(' ', '_') for join_key in list_of_join_keys]
