...
public class ADatabaseManagerTest {
    ...
    public void testADatabaseManager()
    {
        ...
        if (theResourcesFolder.exists())
        {
            ...
            {
                fail ("testADatabaseManager failed to delete the resources folder.");
            }
        }
        ...
        try
        {
            ...
            {
                fail ("A database manager failed to delete a zip code from the table for the saved zip codes");
            }
            ...
            {
                fail ("A database manager failed to update the current zip code.");
            }
            ...
            {
               fail ("A database manager failed to get the current zip code.");
            }
        ...
        {
            fail (theSQLException.getMessage());
        }
