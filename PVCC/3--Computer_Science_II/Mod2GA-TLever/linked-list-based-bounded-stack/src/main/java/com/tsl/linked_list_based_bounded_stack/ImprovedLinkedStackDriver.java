...
public class ImprovedLinkedStackDriver {
	 ...
	 * if the program is terminated while input is being requested from the user, a pop of n names from the stack is
	 * requested when the number of names on the stack is less than n, and when a classic pop from the stack is requested
