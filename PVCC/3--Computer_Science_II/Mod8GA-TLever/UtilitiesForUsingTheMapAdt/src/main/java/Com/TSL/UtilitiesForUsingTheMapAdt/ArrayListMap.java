...
public class ArrayListMap<K, V>  implements MapInterface<K,V>
{
	...
	/**
	 * ArrayListMap() is a zero-parameter constructor for ArrayListMap, which sets the ArrayList of this map to a new
	...
	/**
	 * ArrayListMap(int initCapacity) is a one-parameter constructor for ArrayListMap, which sets the ArrayList of this
	 * map to a new ArrayList with capacity initCapacity.
	 * @param initCapacity
	 */
