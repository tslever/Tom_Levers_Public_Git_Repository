...
void load_weights_upto(network* net, char* filename, int cutoff)
{
    ...
    fflush(stdout);
    // MODIFIED BY TSL ON 06/03/21 00:36
...
list* read_cfg(char* filename)
{
    ...
    // MODIFIED BY TSL ON 08/24/21 23:46
...
void parse_net_options(list* options, network* net)
{
    ...
    net->learning_rate_min = option_find_float_quiet(options, (char*)"learning_rate_min", .00001);
    net->batches_per_cycle = option_find_int_quiet(options, (char*)"sgdr_cycle", net->max_batches);
    net->batches_cycle_mult = option_find_int_quiet(options, (char*)"sgdr_mult", 2);
    ...
    net->track = option_find_int_quiet(options, (char*)"track", 0);
    net->augment_speed = option_find_int_quiet(options, (char*)"augment_speed", 2);
    net->init_sequential_subdivisions = net->sequential_subdivisions = option_find_int_quiet(options, (char*)"sequential_subdivisions", subdivs);
    if (net->sequential_subdivisions > subdivs) net->init_sequential_subdivisions = net->sequential_subdivisions = subdivs;
    net->try_fix_nan = option_find_int_quiet(options, (char*)"try_fix_nan", 0);
    ...
    net->weights_reject_freq = option_find_int_quiet(options, (char*)"weights_reject_freq", 0);
    net->equidistant_point = option_find_int_quiet(options, (char*)"equidistant_point", 0);
    net->badlabels_rejection_percentage = option_find_float_quiet(options, (char*)"badlabels_rejection_percentage", 0);
    net->num_sigmas_reject_badlabels = option_find_float_quiet(options, (char*)"num_sigmas_reject_badlabels", 0);
    net->ema_alpha = option_find_float_quiet(options, (char*)"ema_alpha", 0);
    ...
    *net->cuda_graph_ready = 0;
    net->use_cuda_graph = option_find_int_quiet(options, (char*)"use_cuda_graph", 0);
    net->loss_scale = option_find_float_quiet(options, (char*)"loss_scale", 1);
    net->dynamic_minibatch = option_find_int_quiet(options, (char*)"dynamic_minibatch", 0);
    net->optimized_memory = option_find_int_quiet(options, (char*)"optimized_memory", 0);
    net->workspace_size_limit = (size_t)1024 * 1024 * option_find_float_quiet(options, (char*)"workspace_size_limit_MB", 1024);  // 1024 MB by default
    ...
    if (net->adam) {
        ...
        net->eps = option_find_float(options, (char*)"eps", .000001);
    }
    ...
    net->flip = option_find_int_quiet(options, (char*)"flip", 1);
    net->blur = option_find_int_quiet(options, (char*)"blur", 0);
    net->gaussian_noise = option_find_int_quiet(options, (char*)"gaussian_noise", 0);
    net->mixup = option_find_int_quiet(options, (char*)"mixup", 0);
    int cutmix = option_find_int_quiet(options, (char*)"cutmix", 0);
    int mosaic = option_find_int_quiet(options, (char*)"mosaic", 0);
    if (mosaic && cutmix) net->mixup = 4;
    else if (cutmix) net->mixup = 2;
    else if (mosaic) net->mixup = 3;
    net->letter_box = option_find_int_quiet(options, (char*)"letter_box", 0);
    net->mosaic_bound = option_find_int_quiet(options, (char*)"mosaic_bound", 0);
    net->contrastive = option_find_int_quiet(options, (char*)"contrastive", 0);
    net->contrastive_jit_flip = option_find_int_quiet(options, (char*)"contrastive_jit_flip", 0);
    net->contrastive_color = option_find_int_quiet(options, (char*)"contrastive_color", 0);
    net->unsupervised = option_find_int_quiet(options, (char*)"unsupervised", 0);
    ...
    net->label_smooth_eps = option_find_float_quiet(options, (char*)"label_smooth_eps", 0.0f);
    net->resize_step = option_find_float_quiet(options, (char*)"resize_step", 32);
    net->attention = option_find_int_quiet(options, (char*)"attention", 0);
    net->adversarial_lr = option_find_float_quiet(options, (char*)"adversarial_lr", 0);
    net->max_chart_loss = option_find_float_quiet(options, (char*)"max_chart_loss", 20.0);
    ...
    if (net->policy == STEP) {
        ...
        char* s = option_find(options, (char*)"seq_scales");
...
convolutional_layer parse_convolutional(list* options, size_params params)
{
    ...
    int dilation = option_find_int_quiet(options, (char*)"dilation", 1);
    int antialiasing = option_find_int_quiet(options, (char*)"antialiasing", 0);
    ...
    int assisted_excitation = option_find_float_quiet(options, (char*)"assisted_excitation", 0);

    int share_index = option_find_int_quiet(options, (char*)"share_index", -1000000000);
    ...
    int cbn = option_find_int_quiet(options, (char*)"cbn", 0);
    ...
    int use_bin_output = option_find_int_quiet(options, (char*)"bin_output", 0);
    int sway = option_find_int_quiet(options, (char*)"sway", 0);
    int rotate = option_find_int_quiet(options, (char*)"rotate", 0);
    int stretch = option_find_int_quiet(options, (char*)"stretch", 0);
    int stretch_sway = option_find_int_quiet(options, (char*)"stretch_sway", 0);
    ...
    layer.angle = option_find_float_quiet(options, (char*)"angle", 15);
    layer.grad_centr = option_find_int_quiet(options, (char*)"grad_centr", 0);
    layer.reverse = option_find_float_quiet(options, (char*)"reverse", 0);
    layer.coordconv = option_find_int_quiet(options, (char*)"coordconv", 0);

    layer.stream = option_find_int_quiet(options, (char*)"stream", -1);
    layer.wait_stream_id = option_find_int_quiet(options, (char*)"wait_stream", -1);
...
layer parse_rnn(list* options, size_params params)
{
    ...
    int hidden = option_find_int(options, (char*)"hidden", 1);
    char* activation_s = option_find_str(options, (char*)"activation", (char*)"logistic");
    ACTIVATION activation = get_activation(activation_s);
    int batch_normalize = option_find_int_quiet(options, (char*)"batch_normalize", 0);
    int logistic = option_find_int_quiet(options, (char*)"logistic", 0);
...
layer parse_conv_lstm(list* options, size_params params)
{
    ...
    int size = option_find_int_quiet(options, (char*)"size", 3);
    int stride = option_find_int_quiet(options, (char*)"stride", 1);
    int dilation = option_find_int_quiet(options, (char*)"dilation", 1);
    int pad = option_find_int_quiet(options, (char*)"pad", 0);
    int padding = option_find_int_quiet(options, (char*)"padding", 0);
    if (pad) padding = size / 2;

    int output_filters = option_find_int(options, (char*)"output", 1);
    int groups = option_find_int_quiet(options, (char*)"groups", 1);
    char* activation_s = option_find_str(options, (char*)"activation", (char*)"linear");
    ACTIVATION activation = get_activation(activation_s);
    int batch_normalize = option_find_int_quiet(options, (char*)"batch_normalize", 0);
    int xnor = option_find_int_quiet(options, (char*)"xnor", 0);
    int peephole = option_find_int_quiet(options, (char*)"peephole", 0);
    int bottleneck = option_find_int_quiet(options, (char*)"bottleneck", 0);
    ...
    l.state_constrain = option_find_int_quiet(options, (char*)"state_constrain", params.time_steps * 32);
    l.shortcut = option_find_int_quiet(options, (char*)"shortcut", 0);

    char* lstm_activation_s = option_find_str(options, (char*)"lstm_activation", (char*)"tanh");
    l.lstm_activation = get_activation(lstm_activation_s);
    l.time_normalizer = option_find_float_quiet(options, (char*)"time_normalizer", 1.0);
...
{
    int history_size = option_find_int(options, (char*)"history_size", 4);
...
layer parse_crnn(list* options, size_params params)
{
    ...
    int output_filters = option_find_int(options, (char*)"output", 1);
    int hidden_filters = option_find_int(options, (char*)"hidden", 1);
    int groups = option_find_int_quiet(options, (char*)"groups", 1);
    char* activation_s = option_find_str(options, (char*)"activation", (char*)"logistic");
    ACTIVATION activation = get_activation(activation_s);
    int batch_normalize = option_find_int_quiet(options, (char*)"batch_normalize", 0);
...
layer parse_region(list* options, size_params params)
{
    ...
    l.focal_loss = option_find_int_quiet(options, (char*)"focal_loss", 0);
    //l.max_boxes = option_find_int_quiet(options, "max",30);
    l.jitter = option_find_float(options, (char*)"jitter", .2);
    l.resize = option_find_float_quiet(options, (char*)"resize", 1.0);
    ...
    l.random = option_find_float_quiet(options, (char*)"random", 0);
...
layer parse_yolo(list* options, size_params params)
{
    ...
    l.show_details = option_find_int_quiet(options, (char*)"show_details", 1);
    l.max_delta = option_find_float_quiet(options, (char*)"max_delta", FLT_MAX);   // set 10
    char* cpc = option_find_str(options, (char*)"counters_per_class", 0);
    l.classes_multipliers = get_classes_multipliers(cpc, classes, l.max_delta);

    l.label_smooth_eps = option_find_float_quiet(options, (char*)"label_smooth_eps", 0.0f);
    l.scale_x_y = option_find_float_quiet(options, (char*)"scale_x_y", 1);
    l.objectness_smooth = option_find_int_quiet(options, (char*)"objectness_smooth", 0);
    l.new_coords = option_find_int_quiet(options, (char*)"new_coords", 0);
    l.iou_normalizer = option_find_float_quiet(options, (char*)"iou_normalizer", 0.75);
    l.obj_normalizer = option_find_float_quiet(options, (char*)"obj_normalizer", 1);
    l.cls_normalizer = option_find_float_quiet(options, (char*)"cls_normalizer", 1);
    l.delta_normalizer = option_find_float_quiet(options, (char*)"delta_normalizer", 1);
    char* iou_loss = option_find_str_quiet(options, (char*)"iou_loss", (char*)"mse");   //  "iou");
    ...
    char* iou_thresh_kind_str = option_find_str_quiet(options, (char*)"iou_thresh_kind", (char*)"iou");
    ...
    l.beta_nms = option_find_float_quiet(options, (char*)"beta_nms", 0.6);
    char* nms_kind = option_find_str_quiet(options, (char*)"nms_kind", (char*)"default");
    ...
    l.iou_thresh = option_find_float_quiet(options, (char*)"iou_thresh", 1); // recommended to use iou_thresh=0.213 in [yolo]
    l.random = option_find_float_quiet(options, (char*)"random", 0);

    l.track_history_size = option_find_int_quiet(options, (char*)"track_history_size", 5);
    l.sim_thresh = option_find_int_quiet(options, (char*)"sim_thresh", 0.8);
    l.dets_for_track = option_find_int_quiet(options, (char*)"dets_for_track", 1);
    l.dets_for_show = option_find_int_quiet(options, (char*)"dets_for_show", 1);
    l.track_ciou_norm = option_find_float_quiet(options, (char*)"track_ciou_norm", 0.01);
    int embedding_layer_id = option_find_int_quiet(options, (char*)"embedding_layer", 999999);
...
layer parse_gaussian_yolo(list* options, size_params params) // Gaussian_YOLOv3
{
    ...
    l.scale_x_y = option_find_float_quiet(options, (char*)"scale_x_y", 1);
    l.objectness_smooth = option_find_int_quiet(options, (char*)"objectness_smooth", 0);
    l.uc_normalizer = option_find_float_quiet(options, (char*)"uc_normalizer", 1.0);
    l.iou_normalizer = option_find_float_quiet(options, (char*)"iou_normalizer", 0.75);
    l.obj_normalizer = option_find_float_quiet(options, (char*)"obj_normalizer", 1.0);
    l.cls_normalizer = option_find_float_quiet(options, (char*)"cls_normalizer", 1);
    l.delta_normalizer = option_find_float_quiet(options, (char*)"delta_normalizer", 1);
    char* iou_loss = option_find_str_quiet(options, (char*)"iou_loss", (char*)"mse");   //  "iou");
    ...
    char* yolo_point = option_find_str_quiet(options, (char*)"yolo_point", (char*)"center");
...
detection_layer parse_detection(list* options, size_params params)
{
    ...
    layer.max_boxes = option_find_int_quiet(options, (char*)"max", 200);
    ...
    layer.resize = option_find_float_quiet(options, (char*)"resize", 1.0);
    layer.random = option_find_float_quiet(options, (char*)"random", 0);
...
softmax_layer parse_softmax(list* options, size_params params)
{
    ...
    layer.temperature = option_find_float_quiet(options, (char*)"temperature", 1);
    char* tree_file = option_find_str(options, (char*)"tree", 0);
    if (tree_file) layer.softmax_tree = read_tree(tree_file);
    layer.w = params.w;
    layer.h = params.h;
    layer.c = params.c;
    layer.spatial = option_find_float_quiet(options, (char*)"spatial", 0);
    layer.noloss = option_find_int_quiet(options, (char*)"noloss", 0);
    return layer;
}
...
{
    int classes = option_find_int(options, (char*)"classes", 1000);
    layer* yolo_layer = NULL;
    int yolo_layer_id = option_find_int_quiet(options, (char*)"yolo_layer", 0);
    ...
    layer.cls_normalizer = option_find_float_quiet(options, (char*)"cls_normalizer", 1);
    layer.max_delta = option_find_float_quiet(options, (char*)"max_delta", FLT_MAX);   // set 10
    layer.contrastive_neg_max = option_find_int_quiet(options, (char*)"contrastive_neg_max", 3);
    return layer;
}
...
{
    int stride = option_find_int(options, (char*)"stride", 1);
    int stride_x = option_find_int_quiet(options, (char*)"stride_x", stride);
    int stride_y = option_find_int_quiet(options, (char*)"stride_y", stride);
    int size = option_find_int(options, (char*)"size", stride);
    int padding = option_find_int_quiet(options, (char*)"padding", size - 1);
    int maxpool_depth = option_find_int_quiet(options, (char*)"maxpool_depth", 0);
    int out_channels = option_find_int_quiet(options, (char*)"out_channels", 1);
    int antialiasing = option_find_int_quiet(options, (char*)"antialiasing", 0);
    const int avgpool = 0;
    ...
    layer.maxpool_zero_nonmax = option_find_int_quiet(options, (char*)"maxpool_zero_nonmax", 0);
    return layer;
}
...
route_layer parse_route(list* options, size_params params)
{
    ...
    int groups = option_find_int_quiet(options, (char*)"groups", 1);
    int group_id = option_find_int_quiet(options, (char*)"group_id", 0);
...
layer parse_shortcut(list* options, size_params params, network net)
{
    ...
    char* weights_type_str = option_find_str_quiet(options, (char*)"weights_type", (char*)"none");
    ...
    char* weights_normalization_str = option_find_str_quiet(options, (char*)"weights_normalization", (char*)"none");
...
layer parse_scale_channels(list* options, size_params params, network net)
{
    ...
    int index = atoi(l);
    if (index < 0) index = params.index + index;
    int scale_wh = option_find_int_quiet(options, (char*)"scale_wh", 0);
    ...
    char* activation_s = option_find_str_quiet(options, (char*)"activation", (char*)"linear");
    ACTIVATION activation = get_activation(activation_s);
...
{
    float mean_init = option_find_float(options, (char*)"mean", 0.0);
    float std_init = option_find_float(options, (char*)"std", 0.2);
    int filters = option_find_int(options, (char*)"filters", 128);
    int atoms = option_find_int_quiet(options, (char*)"atoms", 1);
...
{
    float probability = option_find_float(options, (char*)"probability", .2);
    int dropblock = option_find_int_quiet(options, (char*)"dropblock", 0);
    float dropblock_size_rel = option_find_float_quiet(options, (char*)"dropblock_size_rel", 0);
    int dropblock_size_abs = option_find_float_quiet(options, (char*)"dropblock_size_abs", 0);
...
network parse_network_cfg_custom(char* filename, int batch, int time_steps)
{
    ...
    const int show_receptive_field = option_find_float_quiet(options, (char*)"show_receptive_field", 0);
    ...
    while (n) {
        ...
        l.clip = option_find_float_quiet(options, (char*)"clip", 0);
        l.dynamic_minibatch = net.dynamic_minibatch;
        l.onlyforward = option_find_int_quiet(options, (char*)"onlyforward", 0);
        l.dont_update = option_find_int_quiet(options, (char*)"dont_update", 0);
        l.burnin_update = option_find_int_quiet(options, (char*)"burnin_update", 0);
        l.stopbackward = option_find_int_quiet(options, (char*)"stopbackward", 0);
        l.train_only_bn = option_find_int_quiet(options, (char*)"train_only_bn", 0);
