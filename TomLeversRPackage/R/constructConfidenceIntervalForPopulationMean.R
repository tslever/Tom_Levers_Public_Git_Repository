#' @title constructConfidenceIntervalForPopulationMean
...
#' @examples confidence_interval <- constructConfidenceIntervalForPopulationMean(iris$Sepal.Length, 0.05)
#' @export

constructConfidenceIntervalForPopulationMean <- function(data_for_sample, significance_level) {
