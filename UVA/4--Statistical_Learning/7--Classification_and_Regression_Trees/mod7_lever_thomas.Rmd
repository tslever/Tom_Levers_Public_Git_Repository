...
8.  In the lab, a classification tree was applied to the Carseats data set after converting Sales into a qualitative response variable. 
    ...
    (e) Use random forests to analyze this data. What test MSE do you obtain? Use the `importance()` function to determine which variables are most important. Describe the effect of m, the number of variables considered at each split, on the error rate obtained.
        ...
        See above plot for test Mean Squared Errors for different values of the number of variables randomly sampled as candidates at each split. Test MSE decreases exponentially with number of variables. In all cases $ShelveLoc$ and $Price$ are the most important predictors.
