...
8.  In the lab, a classification tree was applied to the Carseats data set after converting Sales into a qualitative response variable. 
    ...
    (b) Fit a regression tree to the training set. Plot the tree, and interpret the results. What test MSE do you obtain?
        ...
        library(tree)
        the_tree <- tree(Sales ~ ., data = training_data)
        summary(the_tree)
        plot(the_tree)
        text(the_tree, pretty = 0)
        vector_of_predicted_sales <- predict(the_tree, newdata = testing_data)
        ...
        The test Mean Squared Error of our tree when predicting sales is $4.896 \ thousands^2$.
