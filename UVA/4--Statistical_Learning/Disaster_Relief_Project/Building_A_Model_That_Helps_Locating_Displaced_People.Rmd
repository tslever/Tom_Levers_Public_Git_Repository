...
$$(F1 \ measure) = \frac{1}{k} \sum_{i = 1}^k \left[(F1 \ measure)_k\right]$$
...
```{r, fig.cap = "Prediction Metrics Vs. Thresholds For Logistic Regression Model With Formula Indicator vs. Normalized Blue + Normalized Red + Normalized Square Of Green", eval = FALSE}
...
```{r, fig.cap = "PR AUC, ROC AUC, Prediction Metrics Vs. Thresholds, PR Curve, ROC Curve, And Performance Table For Logistic Ridge Regression Model With Formula Indicator Vs. Normalized Natural Logarithm Of Blue + Normalized Square Root Of Red", eval = FALSE}
library(TomLeversRPackage)
summarize_performance_of_cross_validated_models_using_dplyr(
...
```{r, fig.cap = "PR AUC, ROC AUC, Prediction Metrics Vs. Thresholds, PR Curve, ROC Curve, And Performance Table For Linear Discriminant Analysis Model With Formula Indicator Vs. Normalized Blue + Normalized Square Of Red + Normalized Square Of Green", eval = FALSE}
library(TomLeversRPackage)
summarize_performance_of_cross_validated_models_using_dplyr(
    type_of_model = "LDA",
...
```{r, fig.cap = "PR AUC, ROC AUC, Prediction Metrics Vs. Thresholds, PR Curve, ROC Curve, And Performance Table For Quadratic Discriminant Analysis Model With Formula Indicator Vs. Normalized Square Of Blue + Normalized Square Of Red + Normalized Red + Normalized Natural Logarithm Of Blue", eval = FALSE}
library(TomLeversRPackage)
summarize_performance_of_cross_validated_models_using_dplyr(
    type_of_model = "QDA",
...
```{r, fig.cap = "PR AUC, ROC AUC, Prediction Metrics Vs. Thresholds, PR Curve, ROC Curve, And Performance Table For KNN Model With Formula Indicator Vs. Normalized Interaction Of Red And Blue And Normalized Interaction Of Green And Blue", eval = FALSE}
library(TomLeversRPackage)
summarize_performance_of_cross_validated_models_using_dplyr(
    type_of_model = "KNN",
