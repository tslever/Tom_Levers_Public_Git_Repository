...
We expect that, due to bias, a binary classifier trained on our training data frame of indicators and pixels below and cross validated on our holdout data frame of indicators and pixels below will have a maximum average F1 measure that is comparable to but less than that of a binary classifier cross validated on our training data frame. We recommend training on our composite data frame of indicators and pixels below.
