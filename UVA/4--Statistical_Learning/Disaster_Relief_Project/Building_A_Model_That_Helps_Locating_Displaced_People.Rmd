...
- Accuracy decreases across KNN CV, SVMWLK CV, RF CV, KNN HT, LR CV, QDA CV, RF HT, LR HT, SVMWLK HT, LRR CV, QDA HT, LRR HT, LDA CV, LDA HT.
- F1 measure decreases across KNN CV, SVMWLK CV, RF CV, LR CV, QDA CV, LRR CV, LDA CV, LRR HT, LR HT, SVMWLK HT, KNN HT, RF HT, LDA HT, QDA HT.
- PPV decreases across LRR CV, QDA CV, RF CV, SVMWLK CV, KNN CV, LR CV, LRR HT, RF HT, LR HT, LDA CV, LDA HT, QDA HT, SVMWLK HT, KNN HT.
- TPR decreases across SVMWLK HT, LR HT, LRR HT, SVMWLK CV, RF CV, KNN CV, LR CV, QDA CV, LDA CV, LRR CV, KNN HT, LDA HT, RF HT, QDA HT.
- PR AUC decreases across LR CV (0.984), SVMWLK CV (0.984), RF CV (0.984), LRR CV (0.982), KNN CV (0.979), LRR HT (0.963), QDA CV (0.959), LR HT (0.918), SVMWLK HT (0.917), LDA CV (0.905), LDA HT (0.739), RF HT (0.710), KNN HT (0.669), QDA HT (0.504).
- ROC AUC decreases across LRR HT (0.9996), LRR CV (0.9992), LR CV (0.9992), SVMWLK HT (0.9991), LR HT (0.9991), SVMWLK CV (0.998), KNN CV (0.994), RF CV (0.9939), QDA CV (0.985), RF HT (0.979), LDA HT (0.953), LDA CV (0.950), KNN HT (0.933), QDA HT (0.786).
