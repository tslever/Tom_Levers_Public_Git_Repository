...
slice_to_plot <- holdout_data_frame_of_classes_and_pixels[vector_of_random_indices, ]
plot_distribution(slice_to_plot, "Red", "red")
```

```{r, eval = TRUE, fig.width = 2.625, fig.height = 1.875}
plot_distribution(slice_to_plot, "Green", "green")
```

```{r, eval = TRUE, fig.width = 2.625, fig.height = 1.875}
plot_distribution(slice_to_plot, "Blue", "blue")
```
