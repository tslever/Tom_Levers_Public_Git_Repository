...
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Prediction Metrics Vs. Thresholds For K Nearest Neighbors Model With Formula Indicator vs. ?", eval = FALSE}
library(TomLeversRPackage)
