...
![Average Performance Metrics Vs. Threshold: Cross Validation: LR](Average_Performance_Metrics_Vs_Threshold--Cross_Validation--LR.png){#id .class height=50%}

![PR And ROC Curves: Cross Validation: LR](PR_And_ROC_Curves--Cross_Validation--LR.png)

![Optimal Performance Metrics: Cross Validation: LR](Optimal_Performance_Metrics--Cross_Validation--LR.png)

![Performance Metrics Vs. Threshold: Holdout Testing: LR](Performance_Metrics_Vs_Threshold--Holdout_Testing--LR.png){#id .class height=50%}

![PR And ROC Curves: Holdout Testing: LR](PR_And_ROC_Curves--Holdout_Testing--LR.png)

![Optimal Performance Metrics: Holdout Testing: LR](Optimal_Performance_Metrics--Holdout_Testing--LR.png)
...
- Our optimal LR classifier has a maximum F1 measure of $0.917$.
- The corresponding threshold is $0.18$.
...
![Average Performance Metrics Vs. Threshold: Cross Validation: LRR](Average_Performance_Metrics_Vs_Threshold--Cross_Validation--LRR.png)

![PR And ROC Curves: Cross Validation: LRR](PR_And_ROC_Curves--Cross_Validation--LRR.png)

![Optimal Performance Metrics: Cross Validation: LRR](Optimal_Performance_Metrics--Cross_Validation--LRR.png)

![Performance Metrics Vs. Threshold: Holdout Testing: LRR](Performance_Metrics_Vs_Threshold--Holdout_Testing--LRR.png)

![PR And ROC Curves: Holdout Testing: LRR](PR_And_ROC_Curves--Holdout_Testing--LRR.png)

![Optimal Performance Metrics: Holdout Testing: LRR](Optimal_Performance_Metrics--Holdout_Testing--LRR.png)
...
- Our optimal LRR classifier has formula $Indicator \sim normalize(Blue) + normalize\left(Red^2\right) + normalize\left(Green^2\right)$.
...
- Our optimal LR classifier has a maximum F1 measure of $0.742$.
...
![Average Performance Metrics Vs. Threshold: Cross Validation: LDA](Average_Performance_Metrics_Vs_Threshold--Cross_Validation--LDA.png)

![PR And ROC Curves: Cross Validation: LDA](PR_And_ROC_Curves--Cross_Validation--LDA.png)

![Optimal Performance Metrics: Cross Validation: LDA](Optimal_Performance_Metrics--Cross_Validation--LDA.png)

![Performance Metrics Vs. Threshold: Holdout Testing: LDA](Performance_Metrics_Vs_Threshold--Holdout_Testing--LDA.png)

![PR And ROC Curves: Holdout Testing: LDA](PR_And_ROC_Curves--Holdout_Testing--LDA.png)

![Optimal Performance Metrics: Holdout Testing: LDA](Optimal_Performance_Metrics--Holdout_Testing--LDA.png)
