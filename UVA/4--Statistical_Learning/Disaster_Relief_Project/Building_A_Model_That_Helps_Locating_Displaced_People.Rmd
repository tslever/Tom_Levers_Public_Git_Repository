...
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Precision / Recall Curve For Linear Discriminant Analysis Model With Formula Indicator vs. Red + Green + Blue", eval = FALSE}
summarize_performance_of_cross_validated_models_using_dplyr(
    type_of_model = "LDA",
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Precision / Recall Curve For Quadratic Discriminant Analysis Model With Formula Indicator vs. Red + Green + Blue", eval = FALSE}
summarize_performance_of_cross_validated_models_using_dplyr(
    type_of_model = "QDA",
    formula = Indicator ~ Red + Green + Blue,
    data_frame = data_frame_of_indicators_and_pixels
