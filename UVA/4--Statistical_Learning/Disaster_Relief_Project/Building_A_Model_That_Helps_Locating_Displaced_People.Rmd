...
- Accuracy per LR cross validation is greater than accuracy per LR holdout testing.
- F1 measure per LR cross validation is greater than F1 measure per LR holdout testing.
- PPV per LR cross validation is greater than PPV per LR holdout testing.
- TPR per LR holdout testing is greater than TPR per LR cross validation.
- PR AUC for LR cross validation is greater than PR AUC for LR holdout testing.
- ROC AUC for LR cross validation is greater than ROC AUC for LR holdout testing.
...
- Accuracy decreases across LR CV, LR HT, LRR CV, LRR HT.
- F1 measure decreases across LR CV, LRR CV, LRR HT, LR HT.
- PPV decreases across LRR CV, LR CV, LRR HT, LR HT.
- TPR decreases across LR HT, LRR HT, LR CV, LRR CV.
- PR AUC decreases across LR CV, LRR CV, LRR HT, LR HT.
- ROC AUC decreases across LRR HT, LRR CV, LR CV, LR HT.
...
- Accuracy decreases across LR CV, LR HT, LRR CV, LRR HT, LDA CV, LDA HT.
- F1 measure decreases across LR CV, LRR CV, LDA CV, LRR HT, LR HT, LDA HT.
- PPV decreases across LRR CV, LR CV, LRR HT, LR HT, LDA CV, LDA HT.
- TPR decreases across LR HT, LRR HT, LR CV, LDA CV, LRR CV, LDA HT.
- PR AUC decreases across LR CV, LRR CV, LRR HT, LR HT, LDA CV, LDA HT.
- ROC AUC decreases across LRR HT, LRR CV, LR CV, LR HT, LDA HT, LDA CV.
...
- Accuracy decreases across LR CV, QDA CV, LR HT, LRR CV, QDA HT, LRR HT, LDA CV, LDA HT.
- F1 measure decreases across LR CV, QDA CV, LRR CV, LDA CV, LRR HT, LR HT, LDA HT, QDA HT.
- PPV decreases across LRR CV, QDA CV, LR CV, LRR HT, LR HT, LDA CV, LDA HT, QDA HT.
- TPR decreases across LR HT, LRR HT, LR CV, QDA CV, LDA CV, LRR CV, LDA HT, QDA HT.
- PR AUC decreases across LR CV, LRR CV, LRR HT, QDA CV, LR HT, LDA CV, LDA HT, QDA HT.
- ROC AUC decreases across LRR HT, LRR CV, LR CV, LR HT, QDA CV, LDA HT, LDA CV, QDA HT.
...
- Accuracy decreases across KNN CV, KNN HT, LR CV, QDA CV, LR HT, LRR CV, QDA HT, LRR HT, LDA CV, LDA HT.
- F1 measure decreases across KNN CV, LR CV, QDA CV, LRR CV, LDA CV, LRR HT, LR HT, KNN HT, LDA HT, QDA HT.
- PPV decreases across LRR CV, QDA CV, KNN CV, LR CV, LRR HT, LR HT, LDA CV, LDA HT, QDA HT, KNN HT.
- TPR decreases across LR HT, LRR HT, KNN CV, LR CV, QDA CV, LDA CV, LRR CV, KNN HT, LDA HT, QDA HT.
- PR AUC decreases across LR CV, LRR CV, KNN CV, LRR HT, QDA CV, LR HT, LDA CV, LDA HT, KNN HT, QDA HT.
- ROC AUC decreases across LRR HT, LRR CV, LR CV, LR HT, KNN CV, QDA CV, LDA HT, LDA CV, KNN HT, QDA HT.
...
list_of_visualizations_of_performance_metrics <- visualize_performance_metrics(
    ...
    training_data = training_data_frame_of_indicators_and_pixels,
    type_of_model = type_of_model,
    list_of_hyperparameters = list(K = 1)
)
list_of_visualizations_of_performance_metrics$plot_of_performance_metrics_vs_threshold
```
...
- Accuracy decreases across KNN CV, RF CV, KNN HT, LR CV, QDA CV, RF HT, LR HT, LRR CV, QDA HT, LRR HT, LDA CV, LDA HT.
- F1 measure decreases across KNN CV, RF CV, LR CV, QDA CV, LRR CV, LDA CV, LRR HT, LR HT, KNN HT, RF HT, LDA HT, QDA HT.
- PPV decreases across LRR CV, QDA CV, RF CV, KNN CV, LR CV, LRR HT, RF HT, LR HT, LDA CV, LDA HT, QDA HT, KNN HT.
- TPR decreases across LR HT, LRR HT, RF CV, KNN CV, LR CV, QDA CV, LDA CV, LRR CV, KNN HT, LDA HT, RF HT, QDA HT.
- PR AUC decreases across LR CV, RF CV, LRR CV, KNN CV, LRR HT, QDA CV, LR HT, LDA CV, LDA HT, RF HT, KNN HT, QDA HT.
- ROC AUC decreases across LRR HT, RF CV, LRR CV, LR CV, LR HT, KNN CV, QDA CV, RF HT, LDA HT, LDA CV, KNN HT, QDA HT.
