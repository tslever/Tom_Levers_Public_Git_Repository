...
4.  Recall that in matrix notation, the least-squares estimators for the regression model can be written as
    ...
    Per section 3.2.1: "Least-Squares Estimation of the Regression Coefficients" in *Introduction to Linear Regression Analysis* by
