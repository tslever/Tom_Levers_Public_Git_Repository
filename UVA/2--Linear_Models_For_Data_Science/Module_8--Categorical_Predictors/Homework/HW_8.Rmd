...
3.  You may only use R as a simple calculator or to find $p$-values or critical values. This question is a continuation of question 2. A
    ...
    of variance for a multiple linear regression model of teacher pay versus public school expenditure per student and geographic area with an
    interaction effect between public school expenditure per student and geographic area.
    
    (a) Carry out a hypothesis test to see if the interaction terms are significant.
    
        The R analysis of variance considers a multiple linear regression model with equation
        $$E(y | x) = \beta_0 + \beta_1 x_1 + \beta_{area} area + \beta_{x_1, area} \ x_1 \ area$$
