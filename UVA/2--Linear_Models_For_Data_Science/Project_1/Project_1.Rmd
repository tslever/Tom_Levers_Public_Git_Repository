...
1. Sirish's insight into why cut is or not most significant
2. Sirish's insight into why color is or is not second-most significant
...
```{r, eval=TRUE, echo=FALSE, results="show", message=FALSE, warning = FALSE}
ggplot(data_set, aes(x = log(weight), y = log(price), color = cut)) +
    geom_point() +
    geom_smooth(method = lm, se = FALSE) +
    labs(
        x = "logarithmicized weight",
        y = "logarithmicized price",
        title = "Logarithmicized Price vs. Logarithmicized Weight vs. Cut"
    ) +
    theme(
        plot.title = element_text(hjust = 0.5),
        axis.text.x = element_text(angle = 90)
