...
# Executive Summary
#This is Kevins addition to the project
...
1. What is this general analysis about?
2. Why are we presenting this general analysis?
3. What are the below visualizations and visualization-specific analysis about?
4. Why are we presenting all these visualizations and visualization-specific analysis?
...
```{r, eval=TRUE, echo=FALSE, results="show", message=FALSE, warning = FALSE,fig.height = 3, fig.width = 6}
library(ggplot2)
options(repr.plot.width=2, repr.plot.height=4)
plot1<-ggplot(data_set, aes(y = weight)) +
...
```{r, eval=TRUE, echo=FALSE, results="show", message=FALSE, warning = FALSE,fig.height = 2, fig.width = 6}
library(ggplot2)
plot3<-ggplot(data_set, aes(y = log(price))) +
    geom_boxplot(fill = "Blue", color = "Orange") +
    labs(
...
```{r, eval=TRUE, echo=FALSE, results="show", message=FALSE, warning = FALSE,fig.height = 4, fig.width = 6}
library(ggplot2)
...
```{r, eval=FALSE, echo=FALSE, results="show", message=FALSE, warning = FALSE,fig.height = 4, fig.width = 6}
library(ggplot2)
...
```{r, eval=TRUE, echo=FALSE, results="show", message=FALSE, warning = FALSE,fig.height = 3, fig.width = 6}
library(ggplot2)
plot5<-ggplot(data_set, aes(x = clarity, y = price)) +
    geom_boxplot(fill = "Blue", color = "Orange") +
...
```{r, eval=TRUE, echo=FALSE, results="show", message=FALSE, warning = FALSE,fig.height = 3, fig.width = 6}
library(ggplot2)
plot6<-ggplot(data_set %>% filter(clarity != "FL"), aes(x = clarity, y = price)) +
    geom_boxplot(outlier.shape = NA, fill = "Blue", color = "Orange") +
    coord_cartesian(ylim = c(0, 1.5*10^4)) +
    labs(title = "Distributions of Price by Clarity") +
    theme(
...
```{r, eval=TRUE, echo=FALSE, results="show", message=FALSE, warning = FALSE,fig.height = 3, fig.width = 6}
library(ggplot2)
plot14<-ggplot(data_set, aes(x = weight, y = price)) +
